...
function displayCourses(courseArray) {
  ...
  courseArray.forEach(course => {
    ...
    card.innerHTML = `
      ...
      <p><em>${course.credits} credits</em></p>
    `;
...
function displayCreditSummary(courseArray) {
  const totalCredits = calculateCredits(courseArray);
...
function showCourses(courseArray) {
  displayCreditSummary(courseArray);
